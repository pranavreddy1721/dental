      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-28">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="hidden lg:flex flex-col gap-4">
            ...
            {/* Doctors card */}
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl px-6 py-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl px-5 py-4">
                <div className="flex items-center gap-2 mb-3">
                  <Clock size={16} className="text-[#80DEEA]" />
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl px-5 py-4">
                <div className="flex items-center gap-2 mb-3">
                  <MapPin size={16} className="text-[#80DEEA]" />
            ...
            {/* Google rating strip */}
            <div className="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl px-6 py-4 flex items-center justify-between">
